                        ...
                        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                          {products.map((product) => (
                            <Link to="/product-detail">
                              <div
                                key={product.id}
                                className="group relative border-solid border-2 border-gray-100 p-7"
                              >
                                ...
                                <div className="mt-4 flex justify-between">
                                  <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">
                                      <StarIcon className="w-6 h-6 mx-2 inline"></StarIcon>
                                  ...
                                  <div>
                                    ...
                                    <p className="text-sm font-medium block line-through text-gray-500">
                                      ${product.price}
                                    </p>
                                  </div>
                                </div>
