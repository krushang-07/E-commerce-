  ...
  return (
    <>
      <div className="mx-auto mt-24 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5 py-5">
          ...
          <div className="lg:col-span-2">
            <div>
              <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                <h2 className="text-3xl flex align-text-middle font-bold tracking-tight text-gray-900 m-5">
                  Cart
                </h2>
